...
- under the hood, this semantical understanding works on embeddings, data is converted into embeddings, internally that data is mapped into a vector space where data related to each other get closer and other stay far. In this way embeddings works.